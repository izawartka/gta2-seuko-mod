...
typedef enum KEYBOARD_STATE {
	KEYBOARD_STATE_ALT=1024,
	KEYBOARD_STATE_ATTACK=16,
	KEYBOARD_STATE_ENTER=32,
	KEYBOARD_STATE_JUMP=64,
	KEYBOARD_STATE_MOVE_BACKWARD=2,
	KEYBOARD_STATE_MOVE_FORWARD=1,
	KEYBOARD_STATE_ROTATE_LEFT=4,
	KEYBOARD_STATE_ROTATE_RIGHT=8,
	KEYBOARD_STATE_TAB=512
} KEYBOARD_STATE;

...
typedef enum CAR_DELTAS_INDEX {
	CAR_DELTAS_INDEX_LIGHT_BROKEN_RR = 0,
	CAR_DELTAS_INDEX_LIGHT_BROKEN_RL = 1,
	CAR_DELTAS_INDEX_LIGHT_BROKEN_FL = 2,
	CAR_DELTAS_INDEX_LIGHT_BROKEN_FR = 3,
	CAR_DELTAS_INDEX_FRONT_GLASS_BROKEN = 4,
	CAR_DELTAS_INDEX_LIGHT_ON_RL = 5,
	CAR_DELTAS_INDEX_LIGHT_ON_FL = 6,
	CAR_DELTAS_INDEX_DOOR_FL_1 = 7,
	CAR_DELTAS_INDEX_DOOR_FL_2 = 8,
	CAR_DELTAS_INDEX_DOOR_FL_3 = 9,
	CAR_DELTAS_INDEX_DOOR_FL_4 = 10,
	CAR_DELTAS_INDEX_DOOR_RL_1 = 11,
	CAR_DELTAS_INDEX_DOOR_RL_2 = 12,
	CAR_DELTAS_INDEX_DOOR_RL_3 = 13,
	CAR_DELTAS_INDEX_DOOR_RL_4 = 14,
	CAR_DELTAS_INDEX_EMERG_LIGHT_FR = 15,
	CAR_DELTAS_INDEX_EMERG_LIGHT_FL = 16,
	CAR_DELTAS_INDEX_EMERG_LIGHT_RR = 17,
	CAR_DELTAS_INDEX_EMERG_LIGHT_RL = 18,
	CAR_DELTAS_INDEX_UNK_19 = 19,
	CAR_DELTAS_INDEX_UNK_20 = 20,
	CAR_DELTAS_INDEX_UNK_21 = 21,
	CAR_DELTAS_INDEX_LIGHT_ON_RR = 22,
	CAR_DELTAS_INDEX_LIGHT_ON_FR = 23,
	CAR_DELTAS_INDEX_DOOR_FR_1 = 24,
	CAR_DELTAS_INDEX_DOOR_FR_2 = 25,
	CAR_DELTAS_INDEX_DOOR_FR_3 = 26,
	CAR_DELTAS_INDEX_DOOR_FR_4 = 27,
	CAR_DELTAS_INDEX_DOOR_RR_1 = 28,
	CAR_DELTAS_INDEX_DOOR_RR_2 = 29,
	CAR_DELTAS_INDEX_DOOR_RR_3 = 30,
	CAR_DELTAS_INDEX_DOOR_RR_4 = 31,
} CAR_DELTAS_INDEX;

typedef enum CAR_DELTAS_BITSTATE {
	CAR_DELTAS_BITSTATE_LIGHT_BROKEN_RR = 1,
	CAR_DELTAS_BITSTATE_LIGHT_BROKEN_RL = 2,
	CAR_DELTAS_BITSTATE_LIGHT_BROKEN_FL = 4,
	CAR_DELTAS_BITSTATE_LIGHT_BROKEN_FR = 8,
	CAR_DELTAS_BITSTATE_FRONT_GLASS_BROKEN = 16,
	CAR_DELTAS_BITSTATE_LIGHT_ON_RL = 32,
	CAR_DELTAS_BITSTATE_LIGHT_ON_FL = 64,
	CAR_DELTAS_BITSTATE_DOOR_FL_1 = 128,
	CAR_DELTAS_BITSTATE_DOOR_FL_2 = 256,
	CAR_DELTAS_BITSTATE_DOOR_FL_3 = 512,
	CAR_DELTAS_BITSTATE_DOOR_FL_4 = 1024,
	CAR_DELTAS_BITSTATE_DOOR_RL_1 = 2048,
	CAR_DELTAS_BITSTATE_DOOR_RL_2 = 4096,
	CAR_DELTAS_BITSTATE_DOOR_RL_3 = 8192,
	CAR_DELTAS_BITSTATE_DOOR_RL_4 = 16384,
	CAR_DELTAS_BITSTATE_EMERG_LIGHT_FR = 32768,
	CAR_DELTAS_BITSTATE_EMERG_LIGHT_FL = 65536,
	CAR_DELTAS_BITSTATE_EMERG_LIGHT_RR = 131072,
	CAR_DELTAS_BITSTATE_EMERG_LIGHT_RL = 262144,
	CAR_DELTAS_BITSTATE_UNK_19 = 524288,
	CAR_DELTAS_BITSTATE_UNK_20 = 1048576,
	CAR_DELTAS_BITSTATE_UNK_21 = 2097152,
	CAR_DELTAS_BITSTATE_LIGHT_ON_RR = 4194304,
	CAR_DELTAS_BITSTATE_LIGHT_ON_FR = 8388608,
	CAR_DELTAS_BITSTATE_DOOR_FR_1 = 16777216,
	CAR_DELTAS_BITSTATE_DOOR_FR_2 = 33554432,
	CAR_DELTAS_BITSTATE_DOOR_FR_3 = 67108864,
	CAR_DELTAS_BITSTATE_DOOR_FR_4 = 134217728,
	CAR_DELTAS_BITSTATE_DOOR_RR_1 = 268435456,
	CAR_DELTAS_BITSTATE_DOOR_RR_2 = 536870912,
	CAR_DELTAS_BITSTATE_DOOR_RR_3 = 1073741824,
	CAR_DELTAS_BITSTATE_DOOR_RR_4 = 2147483648
} CAR_DELTAS_BITSTATE;
...
typedef enum CAR_ENGINE_STATE {
	CAR_ENGINE_STATE_UNK_0 = 0,
	CAR_ENGINE_STATE_OFF = 1,
	CAR_ENGINE_STATE_TURNING_OFF = 2,
	CAR_ENGINE_STATE_ON = 3,
	CAR_ENGINE_STATE_TURNING_ON = 4,
	CAR_ENGINE_STATE_BREAKING = 5,
	CAR_ENGINE_STATE_BROKEN = 6
} CAR_ENGINE_STATE;
...
typedef enum CAR_LIGHTS_BITSTATE : unsigned char {
	CAR_LIGHTS_BITSTATE_BRAKE_LIGHTS_ON = 1,
	CAR_LIGHTS_BITSTATE_LIGHTS_ON = 2,
	CAR_LIGHTS_BITSTATE_SIREN_ON = 4,
	CAR_LIGHTS_BITSTATE_ALARM_ON = 8,
} CAR_LIGHTS_BITSTATE;
...
typedef enum PED_REMAP : unsigned char {
	...
	PED_REMAP_GREEN_SHORTS_PED=15,
	PED_REMAP_MEDIC=16,
	PED_REMAP_MUGGER=17,
	PED_REMAP_BLUE_DUMMY=18,
	PED_REMAP_LIGHT_BLUE_DUMMY=19,
	PED_REMAP_TSHIRT_AND_SHORTS_DUMMY=20,
	PED_REMAP_SHORT_SLEEVED_SHIRT_AND_TROUSERS_DUMMY=21,
	PED_REMAP_PRISON_UNIFORM=22,
	PED_REMAP_HULK1=23,
	PED_REMAP_HULK2=24,
	PED_REMAP_PLAYER=25,
	PED_REMAP_NAKED=26,
	PED_REMAP_DUMMY_27=27,
	PED_REMAP_DUMMY_28=28,
	PED_REMAP_DUMMY_29=29,
	PED_REMAP_DUMMY_30=30,
	PED_REMAP_DUMMY_31=31,
	PED_REMAP_DUMMY_32=32,
	PED_REMAP_DUMMY_33=33,
	PED_REMAP_DUMMY_34=34,
	PED_REMAP_DUMMY_35=35,
	PED_REMAP_DUMMY_36=36,
	PED_REMAP_DUMMY_37=37,
	PED_REMAP_DUMMY_38=38,
	PED_REMAP_DUMMY_39=39,
	PED_REMAP_DUMMY_40=40,
	PED_REMAP_DUMMY_41=41,
	PED_REMAP_DUMMY_42=42,
	PED_REMAP_DUMMY_43=43,
	PED_REMAP_DUMMY_44=44,
	PED_REMAP_DUMMY_45=45,
	PED_REMAP_DUMMY_46=46,
	PED_REMAP_DUMMY_47=47,
	PED_REMAP_DUMMY_48=48,
	PED_REMAP_DUMMY_49=49,
	PED_REMAP_DUMMY_50=50,
	PED_REMAP_DUMMY_51=51,
	PED_REMAP_DUMMY_52=52,
} PED_REMAP;
...
typedef enum PED_GRAPHIC_TYPE {
	PED_GRAPHIC_TYPE_DUMMY=0,
	PED_GRAPHIC_TYPE_EMERG=1,
	PED_GRAPHIC_TYPE_GANG=2
} PED_GRAPHIC_TYPE;
...
typedef enum SPRITE_TYPE {
	...
	SPRITE_TYPE_CAR = 2,
	SPRITE_TYPE_PED = 3,
	SPRITE_TYPE_CODE_OBJ = 4,
	SPRITE_TYPE_MAP_OBJ = 5,
	SPRITE_TYPE_USER = 6,
	SPRITE_TYPE_FONT = 7
} SPRITE_TYPE;

typedef enum CAR_WEAPON_INDEX {
	CAR_WEAP_BOMB = 15,
	CAR_WEAP_OIL = 16,
	CAR_WEAP_MINE = 17,
	CAR_WEAP_GUN = 18,
...
typedef enum OBJECT_TYPE {
	OBJECT_TYPE_BIN_LID = 1,
	OBJECT_TYPE_BOLLARD = 2,
	OBJECT_TYPE_CONE = 3,
	OBJECT_TYPE_BOXES = 4,
	OBJECT_TYPE_BLASTER = 5,
	OBJECT_TYPE_RUBBISH = 6,
	OBJECT_TYPE_BIN = 7,
	OBJECT_TYPE_ANIMATING_OIL = 8,
	OBJECT_TYPE_OIL = 9,
	OBJECT_TYPE_MINE = 10,
	OBJECT_TYPE_BUSH = 11,
	OBJECT_TYPE_CRATE = 12,
	OBJECT_TYPE_FOOTY = 13,
	OBJECT_TYPE_HARDBOX = 14,
	OBJECT_TYPE_NEWSDIS = 15,
	OBJECT_TYPE_OILDRUM = 16,
	OBJECT_TYPE_TYRE = 17,
	OBJECT_TYPE_HYDRANT_LID = 18,
	OBJECT_TYPE_HYDRANT = 19,
	OBJECT_TYPE_HYDRANT_UNLID = 20,
	OBJECT_TYPE_ROADBLOCK = 21,
	OBJECT_TYPE_BENCH = 22,
	OBJECT_TYPE_PACKAGE = 23,
	OBJECT_TYPE_UNKNOWN_OBJ = 24,
	OBJECT_TYPE_TOWER = 25,
	OBJECT_TYPE_EXPLODE_MEDIUM = 42,
	OBJECT_TYPE_MOVING_PACKAGE = 43, // unofficial name
	OBJECT_TYPE_DEAD_PACKAGE = 44, // unofficial name
	OBJECT_TYPE_MOVING_BENCH = 45, // unofficial name
	OBJECT_TYPE_DEAD_BENCH = 46, // unofficial name
	OBJECT_TYPE_MOVING_ROADBLOCK = 47, // unofficial name
	OBJECT_TYPE_DEAD_ROADBLOCK = 48, // unofficial name
	OBJECT_TYPE_MOVING_HYDRANT_LID = 49, // unofficial name
	OBJECT_TYPE_ANIMATING_CRATE = 50, // unofficial name
	OBJECT_TYPE_DEAD_CRATE = 51, // unofficial name
	OBJECT_TYPE_DEAD_BOXES = 52, // unofficial name
	OBJECT_TYPE_DEAD_CONE = 53, // unofficial name
	OBJECT_TYPE_DEAD_BLASTER = 54, // unofficial name
	OBJECT_TYPE_DEAD_BUSH = 55, // unofficial name
	OBJECT_TYPE_MOVING_FOOTY = 56, // unofficial name
	OBJECT_TYPE_MOVING_HARDBOX = 57, // unofficial name
	OBJECT_TYPE_DEAD_HARDBOX = 58, // unofficial name
	OBJECT_TYPE_MOVING_NEWSDIS = 59, // unofficial name
	OBJECT_TYPE_DEAD_NEWSDIS = 60, // unofficial name
	OBJECT_TYPE_MOVING_OILDRUM = 61, // unofficial name
	OBJECT_TYPE_DEAD_OILDRUM = 62, // unofficial name
	OBJECT_TYPE_MOVING_TYRE = 63, // unofficial name

	/* moving collectables */
	OBJECT_TYPE_MOVING_COLLECT_00_PISTOL = 64,
	OBJECT_TYPE_MOVING_COLLECT_01_S_UZI = 65,
	OBJECT_TYPE_MOVING_COLLECT_02_ROCKET_LAUNCHER = 66,
	OBJECT_TYPE_MOVING_COLLECT_03_ELECTROGUN = 67,
	OBJECT_TYPE_MOVING_COLLECT_04_MOLOTOV_COCTAIL = 68,
	OBJECT_TYPE_MOVING_COLLECT_05_GRENADE = 69,
	OBJECT_TYPE_MOVING_COLLECT_06_SHOTGUN = 70,
	OBJECT_TYPE_MOVING_COLLECT_07_ELECTROBATON = 71,
	OBJECT_TYPE_MOVING_COLLECT_08_FLAMETHROWER = 72,
	OBJECT_TYPE_MOVING_COLLECT_09_SILENCED_S_UZI = 73,
	OBJECT_TYPE_MOVING_COLLECT_10_DUAL_PISTOL = 74,
	OBJECT_TYPE_MOVING_COLLECT_11_LETTER_L = 75,
	OBJECT_TYPE_MOVING_COLLECT_12_LETTER_M = 76,
	OBJECT_TYPE_MOVING_COLLECT_13_LETTER_N = 77,
	OBJECT_TYPE_MOVING_COLLECT_14_LETTER_O = 78,

	OBJECT_TYPE_MOVING_COLLECT_15_VEHICLE_BOMB = 79,
	OBJECT_TYPE_MOVING_COLLECT_16_VEHICLE_OIL_SLICK = 80,
	OBJECT_TYPE_MOVING_COLLECT_17_VEHICLE_MINE = 81,
	OBJECT_TYPE_MOVING_COLLECT_18_VEHICLE_MACHINE_GUN = 82,
	OBJECT_TYPE_MOVING_COLLECT_19_TANK_CANNON = 83,
	OBJECT_TYPE_MOVING_COLLECT_20_WATER_CANNON = 84,
	OBJECT_TYPE_MOVING_COLLECT_21_VEHICLE_FLAMETHROWER = 85,
	OBJECT_TYPE_MOVING_COLLECT_22_JEEP_TURRET = 86,
	OBJECT_TYPE_MOVING_COLLECT_23_INSTANT_VEHICLE_BOMB = 87,
	OBJECT_TYPE_MOVING_COLLECT_24_LETTER_J = 88,
	OBJECT_TYPE_MOVING_COLLECT_25_LETTER_K = 89,
	OBJECT_TYPE_MOVING_COLLECT_26_LETTER_L = 90,
	OBJECT_TYPE_MOVING_COLLECT_27_LETTER_M = 91,

	OBJECT_TYPE_MOVING_COLLECT_28_MULTIPLIER_PLUS_1 = 92,
	OBJECT_TYPE_MOVING_COLLECT_29_LIFE_PLUS_1 = 93,
	OBJECT_TYPE_MOVING_COLLECT_30_HEALTH = 94,
	OBJECT_TYPE_MOVING_COLLECT_31_ARMOR = 95,
	OBJECT_TYPE_MOVING_COLLECT_32_GET_OUTTA_JAIL_FREE_CARD = 96,
	OBJECT_TYPE_MOVING_COLLECT_33_COP_BRIBE = 97,
	OBJECT_TYPE_MOVING_COLLECT_34_INVULNERABILITY = 98,
	OBJECT_TYPE_MOVING_COLLECT_35_DOUBLE_DAMAGE = 99,
	OBJECT_TYPE_MOVING_COLLECT_36_FAST_RELOAD = 100,
	OBJECT_TYPE_MOVING_COLLECT_37_ELECTROFINGERS = 101,
	OBJECT_TYPE_MOVING_COLLECT_38_RESPECT = 102,
	OBJECT_TYPE_MOVING_COLLECT_39_INVISIBILITY = 103,
	OBJECT_TYPE_MOVING_COLLECT_40_INSTANT_GANG = 104,
	OBJECT_TYPE_MOVING_COLLECT_41_LETTER_N = 105,
	OBJECT_TYPE_MOVING_COLLECT_42_LETTER_O = 106,
	OBJECT_TYPE_MOVING_COLLECT_43_LETTER_P = 107,
	OBJECT_TYPE_MOVING_COLLECT_44_LETTER_Q = 108,

	OBJECT_TYPE_SMALL_ARROW = 109,
	OBJECT_TYPE_BLOOD_SPARK = 111,
	OBJECT_TYPE_PARTICLE_SYSTEM = 113,
	OBJECT_TYPE_FIREJET = 114,
	OBJECT_TYPE_SMALL_BROWN_SKID = 116,
	OBJECT_TYPE_SMALL_GREY_SKID = 117,
	OBJECT_TYPE_SMALL_RED_SKID = 118,
	OBJECT_TYPE_MEDIUM_BROWN_SKID = 119,
	OBJECT_TYPE_MEDIUM_GREY_SKID = 120,
	OBJECT_TYPE_MEDIUM_RED_SKID = 121,
	OBJECT_TYPE_CAR_CROSSING = 122,
	OBJECT_TYPE_MOVING_BUSH = 123,
	OBJECT_TYPE_BIG_WHITE_SKID = 124,
	OBJECT_TYPE_MEDIUM_WHITE_SKID = 125,
	OBJECT_TYPE_SMALL_WHITE_SKID = 126,
	OBJECT_TYPE_ROCKET = 128,
	OBJECT_TYPE_BUS_STOP_MARKER = 129,
	OBJECT_TYPE_CAR_SHOP = 130,
	OBJECT_TYPE_BUSY_CAR_SHOP = 131,
	OBJECT_TYPE_CAR_BOMB = 132,
	OBJECT_TYPE_MOLOTOV_MOVING = 138,
	OBJECT_TYPE_HUGE_RED_SKID = 144,
	OBJECT_TYPE_HUGE_WHITE_SKID = 145,
	OBJECT_TYPE_HUGE_BROWN_SKID = 146,
	OBJECT_TYPE_HUGE_GREY_SKID = 147,
	OBJECT_TYPE_TANKTOP = 148,
	OBJECT_TYPE_ANTENNA = 149,
	OBJECT_TYPE_ANIMATING_RUBBISH = 151,
	OBJECT_TYPE_DEAD_RUBBISH = 152,
	OBJECT_TYPE_MOVING_CONE = 155,
	OBJECT_TYPE_MOVING_BLASTER = 156, // unofficial name
	OBJECT_TYPE_MOVING_BIN = 157, // unofficial name
	OBJECT_TYPE_MOVING_BIN_LID = 158,
	OBJECT_TYPE_SAVE_POINT = 161, // unofficial name
	OBJECT_TYPE_PHONE = 163,
	OBJECT_TYPE_PHONE_RINGING = 164,
	OBJECT_TYPE_DEAD_MINE = 165, // unofficial name // not sure about this one
	OBJECT_TYPE_PHONE_DEAD = 174,
	OBJECT_TYPE_BRIEFCASE = 175,
	OBJECT_TYPE_RED_PHONE = 176,
	OBJECT_TYPE_RED_PHONE_RINGING = 177,
	OBJECT_TYPE_YELLOW_PHONE = 178,
	OBJECT_TYPE_YELLOW_PHONE_RINGING = 179,
	OBJECT_TYPE_GREEN_PHONE = 180,
	OBJECT_TYPE_GREEN_PHONE_RINGING = 181,
	OBJECT_TYPE_GRENADE = 182,
	OBJECT_TYPE_SHOT = 192,
	OBJECT_TYPE_FLAMING_BULLET = 194,
	OBJECT_TYPE_FIRE = 197,
	OBJECT_TYPE_WATER_BULLET = 198,

	OBJECT_TYPE_COLLECT_00_PISTOL = 200,
	OBJECT_TYPE_COLLECT_01_S_UZI = 201,
	OBJECT_TYPE_COLLECT_02_ROCKET_LAUNCHER = 202,
	OBJECT_TYPE_COLLECT_03_ELECTROGUN = 203,
	OBJECT_TYPE_COLLECT_04_MOLOTOV_COCTAIL = 204,
	OBJECT_TYPE_COLLECT_05_GRENADE = 205,
	OBJECT_TYPE_COLLECT_06_SHOTGUN = 206,
	OBJECT_TYPE_COLLECT_07_ELECTROBATON = 207,
	OBJECT_TYPE_COLLECT_08_FLAMETHROWER = 208,
	OBJECT_TYPE_COLLECT_09_SILENCED_S_UZI = 209,
	OBJECT_TYPE_COLLECT_10_DUAL_PISTOL = 210,
	OBJECT_TYPE_COLLECT_11_LETTER_L = 211,
	OBJECT_TYPE_COLLECT_12_LETTER_M = 212,
	OBJECT_TYPE_COLLECT_13_LETTER_N = 213,
	OBJECT_TYPE_COLLECT_14_LETTER_O = 214,
	OBJECT_TYPE_COLLECT_15_VEHICLE_BOMB = 215,
	OBJECT_TYPE_COLLECT_16_VEHICLE_OIL_SLICK = 216,
	OBJECT_TYPE_COLLECT_17_VEHICLE_MINE = 217,
	OBJECT_TYPE_COLLECT_18_VEHICLE_MACHINE_GUN = 218,
	OBJECT_TYPE_COLLECT_19_TANK_CANNON = 219,
	OBJECT_TYPE_COLLECT_20_WATER_CANNON = 220,
	OBJECT_TYPE_COLLECT_21_VEHICLE_FLAMETHROWER = 221,
	OBJECT_TYPE_COLLECT_22_JEEP_TURRET = 222,
	OBJECT_TYPE_COLLECT_23_INSTANT_VEHICLE_BOMB = 223,
	OBJECT_TYPE_COLLECT_24_LETTER_J = 224,
	OBJECT_TYPE_COLLECT_25_LETTER_K = 225,
	OBJECT_TYPE_COLLECT_26_LETTER_L = 226,
	OBJECT_TYPE_COLLECT_27_LETTER_M = 227,
	OBJECT_TYPE_COLLECT_28_MULTIPLIER_PLUS_1 = 228,
	OBJECT_TYPE_COLLECT_29_LIFE_PLUS_1 = 229,
	OBJECT_TYPE_COLLECT_30_HEALTH = 230,
	OBJECT_TYPE_COLLECT_31_ARMOR = 231,
	OBJECT_TYPE_COLLECT_32_GET_OUTTA_JAIL_FREE_CARD = 232,
	OBJECT_TYPE_COLLECT_33_COP_BRIBE = 233,
	OBJECT_TYPE_COLLECT_34_INVULNERABILITY = 234,
	OBJECT_TYPE_COLLECT_35_DOUBLE_DAMAGE = 235,
	OBJECT_TYPE_COLLECT_36_FAST_RELOAD = 236,
	OBJECT_TYPE_COLLECT_37_ELECTROFINGERS = 237,
	OBJECT_TYPE_COLLECT_38_RESPECT = 238,
	OBJECT_TYPE_COLLECT_39_INVISIBILITY = 239,
	OBJECT_TYPE_COLLECT_40_INSTANT_GANG = 240,
	OBJECT_TYPE_COLLECT_41_LETTER_N = 241,
	OBJECT_TYPE_COLLECT_42_LETTER_O = 242,
	OBJECT_TYPE_COLLECT_43_LETTER_P = 243,
	OBJECT_TYPE_COLLECT_44_LETTER_Q = 244,

	OBJECT_TYPE_BOMB = 247,
	OBJECT_TYPE_BIG_BROWN_SKID = 249,
	OBJECT_TYPE_BIG_GREY_SKID = 250,
	OBJECT_TYPE_BIG_RED_SKID = 253,
	OBJECT_TYPE_BULLET = 254,
	OBJECT_TYPE_TRAFFIC_LIGHT = 255,
	OBJECT_TYPE_RED_FOOTPRINTS = 256,
	OBJECT_TYPE_BLOOD = 257,
	OBJECT_TYPE_CROSSING = 258,
	OBJECT_TYPE_SPARK = 259,
	OBJECT_TYPE_PISTOL_BULLET = 265,
	OBJECT_TYPE_BONUS_TOKEN = 266,
	OBJECT_TYPE_TASSER_BULLET = 277,
	OBJECT_TYPE_SOUND_INSTANT = 279,
	OBJECT_TYPE_INVISIBLE_TARGET = 280,
	OBJECT_TYPE_POWERGEN = 281,
	OBJECT_TYPE_POWERGEN_DEAD = 282,
	OBJECT_TYPE_INVISIBLE_DESTRUCTIBLE = 283,
	OBJECT_TYPE_GENLITE = 284,
	OBJECT_TYPE_INVISIBLE_DEAD = 285,
	OBJECT_TYPE_KILL_FRENZY = 286,
	OBJECT_TYPE_TUNNEL_BLOCKER = 294,
	OBJECT_TYPE_REMOTE = 295
} OBJECT_TYPE;
...
struct Ped {
	...
	enum PED_GRAPHIC_TYPE graphicType;
	int field_0x270;
...
typedef enum KEYBOARD_STATE {
	KEYBOARD_STATE_FORWARD = 1,
	KEYBOARD_STATE_BACKWARD = 2,
	KEYBOARD_STATE_LEFT = 4,
	KEYBOARD_STATE_RIGHT = 8,
	KEYBOARD_STATE_ATTACK = 16,
	KEYBOARD_STATE_ENTER_CAR = 32,
	KEYBOARD_STATE_JUMP = 64,
	KEYBOARD_STATE_PREV_WEAPON = 128,
	KEYBOARD_STATE_NEXT_WEAPON = 256,
	KEYBOARD_STATE_SPECIAL = 512,
	KEYBOARD_STATE_SPECIAL2 = 1024,
	KEYBOARD_STATE_SPECIAL3 = 2048,
} KEYBOARD_STATE;
...
typedef enum PALETTE_BASE {
	PALETTE_BASE_TILE=1,
	PALETTE_BASE_SPRITE=2,
	PALETTE_BASE_CAR_REMAP=3,
	PALETTE_BASE_PED_REMAP=4,
	PALETTE_BASE_CODE_OBJ_REMAP=5,
	PALETTE_BASE_MAP_OBJ_REMAP=6,
	PALETTE_BASE_USER_REMAP=7,
	PALETTE_BASE_FONT_REMAP=8
} PALETTE_BASE;
